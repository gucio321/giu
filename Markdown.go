...
// // https://github.com/juliettef/cimgui_markdown
// // It is like LabelWidget but with md formatting.
//
//	type MarkdownWidget struct {
//		md      *string
//		linkCb  func(url string)
//		headers []cimgui.MarkdownHeaderData
//	}
//
...
//		if m.headers == nil {
//			m.headers = make([]cimgui.MarkdownHeaderData, level)
//		}
//
//		if level <= len(m.headers) {
//			m.headers = append(m.headers, make([]cimgui.MarkdownHeaderData, len(m.headers)-level+1)...)
//		}
//
//		if font != nil {
...
//		cimgui.Markdown(Context.FontAtlas.RegisterStringPointer(m.md), m.linkCb, loadImage, m.headers)
//	}
//
//	func loadImage(path string) cimgui.MarkdownImageData {
//		var img *image.RGBA
//
//		var err error
//
...
//
//			if respErr != nil {
//				return cimgui.MarkdownImageData{}
//			}
//
//			defer func() {
