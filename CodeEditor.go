...
//
// // CodeEditorWidget represents cimgui.TextEditor.
//
...
//
//	func (ce *CodeEditorWidget) ErrorMarkers(markers cimgui.ErrorMarkers) *CodeEditorWidget {
